...
#ROOT PRIVILEGIES
if [[ $EUID -ne 0 ]]; then
        echo -e "$red You don't have Root privilegies, execute the script as root, use 'sudo' command.$nc"
        exit 1
fi
#Installation
sleep 1
...
echo "  ▄▀▀▀█▄ ▄█▀▄ ██ ▄▄▐█·▄█▀▀█ ██▪      ▐█▐█•▐▀▀▪▄▐█▐▐▌ ▄█▀▄ ▐█ ▌▐▌▐█·"
echo "  ▐█▄▪▐█▐█▌.▐▌▐███▌▐█▌▐█ ▪▐▌▐█▌▐▌     ███ ▐█▄▄▌██▐█▌▐█▌.▐▌██ ██▌▐█▌"
echo -e "▀▀▀▀  ▀█▄▀▪·▀▀▀ ▀▀▀ ▀  ▀ .▀▀▀     . ▀   ▀▀▀ ▀▀ █▪ ▀█▄▀▪▀▀  █▪▀▀▀$nc $blue DailyHijacks$nc"
echo -e "	[+]              $green Developer Qirit0$nc         		   [+]"
echo -e "	[+] 		 $red www.instagram.com/qirit0_0$nc 		   [+]"
echo -e "	[+] 		 $red Credits for our supporters$nc		   [+]"
